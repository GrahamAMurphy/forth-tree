...
Visopen()
{
	...
	mvaddstr(0,0,
" alu in      alu/barrel out       pc             ir         port"
);
	mvaddstr(1,0,
...
"                                    parameter  xxxxxxxx     return  xxxxxxxx");
	mvaddstr(4,0,
"  tbus         abus                    stack:  xxxxxxxx     stack:  xxxxxxxx");
	mvaddstr(5,0,
"xxxxxxxx     xxxxxxxx                          xxxxxxxx             xxxxxxxx");
	mvaddstr(6,0,
"               bbus                            xxxxxxxx             xxxxxxxx");
	mvaddstr(7,0,
"             xxxxxxxx                overflow  xxxxxxxx   overflow  xxxxxxxx");
	mvaddstr(8,0,
"                                               xxxxxxxx             xxxxxxxx");
	mvaddstr(9,0,
...
Updatescr()
{
	...
	Mvprintword(LATCHROW+1,ALUOUTCOL,barrelout);
